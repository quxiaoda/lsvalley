...
/*
  ...
  * {"rank":"5"}
  * */
$.common.getUserRank=function(callback){
...
/*
  ...
  * */
$.common.setUserAddress=function(params){
...
/*
  ...
  * {"status":"success/fail"}
  * */
$.common.weixinPay=function(params,callback){
...
/*
  ...
  * {"status":"success/fail"}
  * */
$.common.aliPay=function(params,callback){
...
/*
  ...
  * {"status":"success/fail"}
  * */
$.common.qqPay=function(params,callback){
...
/*
  ...
  * {"status":"success/fail"}
  * */
$.common.unionPay=function(params,callback){
...
/*
  ...
  * {"status":"success/fail"}
  * */
$.common.applePay=function(params,callback){
...
* */
$.common.getLocationV2=function(callback){
...
/*
  ...
  * */
$.common.backReload=function(params){
...
/**
 * 通知native刷新指定页面模块 版本：4.8.0
 * 使用场景是：当A页面跳转到B页面，B页面执行某个操作后 需要A页面状态更新，发送此消息通知native。
 * @params
 * {"ptype":"orderlist}    ptype:  表示页面模块类型，目前支持:orderlist、orderdetail 模块更新
 * 注：此协议只针对native页 若客户端判断A页面为H5页则不作处理。
 */
$.common.refreshvV2=function(params){
    var param = {"methodname":"refreshv2","methodparam":params};
    $.callNative(param);
};
/*
  *积分商品专用
  ...
  */
$.common.jfNavbar=function(params,callback){
...
*/
$.common.getPayMessage=function(callback){
...
/*
  ...
  * {"pay_type":"weixinapp"}
  */
$.common.getPayIsOk=function(params,callback){
...
/*
  ...
  * */
$.common.getFavStatus=function(callback){
...
/*
  ...
  * */
$.common.setAlarm=function(params,callback){
...
* */
$.common.getAlarmDealData=function(params,callback){
...
/*
  ...
  * */
$.common.getNetworkStatus=function(callback){
...
/*
  ...
  * */
$.common.openBrowser=function(params){
...
/*
  ...
  * */
$.common.openCameraWidget=function(params,callback){
...
/*
  ...
  * */
$.common.startUpload=function(params,callback){
...
/*
  ...
  * */
$.common.getAllMethod=function(callback){
...
/*
  ...
  * */
$.common.openImV2=function(params){
...
* */
$.common.getImStatus=function(callback){
...
/*
  ...
  * */
$.common.destroyHistory=function(params){
...
/*
  * 通知native跳转至特卖商城列表页
  * */
$.common.goToSpecialList=function(){
...
/*
  ...
  * */
$.common.getNativeInfo=function(callback){
...
/*
  ...
  * */
$.common.toDetail=function(params){
...
/*
  ...
  * */
$.common.viewDidAppear=function(callback){
...
/*
  ...
  * */
$.common.openImageWidget=function(params){
...
/*
  ...
  * */
$.common.goToBrandList=function(params){
...
/*
  ...
  * */
$.common.isSupportScheme=function(params,callback){
...
*/
$.common.openContacts=function(callback){
...
/*
  ...
  * */
$.common.toDetailV2=function(params){
...
* url：需要跳转的 url 地址
* */
$.common.retrievePassword=function(params){
...
/*
  ...
  * callback: 空
  * */
$.common.setTitle=function(params){
...
/*
  ...
  * callback: 空
  * */
$.common.getCartNum=function(params){
...
/*
  ...
  * callback: 空
  * */
$.common.shopFavorite=function(params){
...
/*
  ...
  * url：需要跳转的 url 地址
  * */
$.common.bindPhone=function(params){
...
/*
  ...
  * */
$.common.sendPageInfo=function(params){
...
/*
  ...
  * result: 扫描后的结果
  * */
$.common.richScan=function(callback){
...
/*
  ...
  * callback:客户端的回调，带返回值：1表示已收藏，0表示未收藏
  * */
$.common.getFavStatusV2=function(params,callback){
...
/*
  * 通知native打开通知设置dialog
  * methodparam："" 空
  * callback:"" 空
  * 使用场景如：进入支付成功页后，js发送此消息通知native 即可。
  * */
$.common.setNotification=function(){
    var param = {"methodname":"set_notification"};
    $.callNative(param);
};

/*
  * 进入支付成功页后通知native设置dialog_appStore
  * methodparam："" 空
  * callback:"" 空
  * 使用场景如：进入支付成功页后，js发送此消息通知native 即可。
  * */
$.common.dialogAppStore=function(){
    var param = {"methodname":"dialog_appStore"};
    $.callNative(param);
};

/*
* H5活动模板控制显示客户端悬浮标
* methodname：isShowNativeView
* methodparam：[{"type":"1","isshow":"show/hide"},{"type":"2","isshow":"show/hide"},...]
* callback: "" 空
* 参数说明：
* type:string类型，1,2... 各种悬浮标样式，目前就一个样式对应1，便于以后扩展
* isshow: show 显示，hide 隐藏
*/
$.common.isShowNativeView=function(params){
    var param = {"methodname":"isShowNativeView","methodparam":params};
    $.callNative(param);
};
